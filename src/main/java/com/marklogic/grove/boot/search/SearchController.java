...
public class SearchController extends AbstractController {
	...
	public JsonNode search(@PathVariable String type, @RequestBody ObjectNode searchRequest, HttpSession session) {
		...
		StructuredQueryDefinition query = buildQueryWithCriteria(mgr.newStructuredQueryBuilder(type), searchRequest.get("filters"));
	 ...
	 * @return
	 */
	protected StructuredQueryDefinition buildQueryWithCriteria(StructuredQueryBuilder queryBuilder, JsonNode filters) {
	...
	protected StructuredQueryDefinition buildQuery(QueryBuilderAndCriteria builder, JsonNode filters) {
		if (filters.has("and")) {
